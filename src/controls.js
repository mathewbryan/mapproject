...
export const CONTROLS = {
  ...
  showScatterplot: {
    displayName: 'Show Scatter Plot',
    type: 'boolean',
    value: true
  },
  showHeat: {
    displayName: 'Show Heat Map ',
    type: 'boolean',
    value: false
  },
  showGridplot: {
    displayName: 'Show Grid Plot',
    type: 'boolean',
    value: false
  },
  showIcon: {
    displayName: 'Show Radius Offices',
    type: 'boolean',
    value: false
  },
  // showGrid: {
  //   displayName: 'Show Column View',
  //   type: 'boolean',
  //   value: false
  // },
  radius: {
